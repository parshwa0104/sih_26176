  ...
  return (
    <header className="relative z-20 flex h-14 shrink-0 items-center gap-3 border-b border-hairline bg-ocean-850/80 px-3 backdrop-blur lg:h-16 lg:px-5">
      ...
      <form onSubmit={submit} className="ml-3 hidden w-[240px] shrink-0 lg:block xl:w-[280px]">
        <div className="flex h-9 items-center gap-field rounded-lg border border-hairline bg-surface-1/50 px-3 focus-within:border-hairline-strong">
      ...
      <div className="ml-auto flex items-center gap-2">
        <div className="hidden items-center gap-field rounded-lg border border-hairline bg-surface-1/50 px-2.5 py-1.5 font-mono text-meta uppercase text-ink-dim md:flex">
