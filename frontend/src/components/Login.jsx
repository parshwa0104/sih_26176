...
export default function Login() {
  ...
  return (
    <div className="flex min-h-[100dvh] w-full items-center justify-center bg-ocean-900 p-4 font-sans">
      <div className="w-full max-w-sm overflow-hidden rounded-xl border border-hairline-strong bg-ocean-850 shadow-inst">
        ...
        <div className="p-6">
          {error && (
            <div className="mb-4 flex items-start gap-2 rounded-xl border border-status-danger/30 bg-status-danger/10 p-3 text-body text-status-danger">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-hairline bg-surface-1 py-2.5 pl-10 pr-4 text-input text-ink placeholder:font-normal placeholder:text-ink-dim focus:border-accent focus:outline-none"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-hairline bg-surface-1 py-2.5 pl-10 pr-4 text-center text-readout font-bold tracking-[0.3em] text-ink placeholder:font-normal placeholder:tracking-normal placeholder:text-ink-dim focus:border-accent focus:outline-none"
                    required
                    autoFocus
                  />
                </div>
