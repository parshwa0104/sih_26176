...
import { AGENT_POSITIONS } from '../data/investigationLayout.js'
...
export default function InvestigationView({ investigation }) {
  const { phase, query, agentStatus, activeAgentIndex, result, reset, timeline } = investigation
  ...
  return (
    <div className="investigation-view">
      ...
      {showSynthesis && <SynthesisPanel result={result} agents={agents} onReset={reset} />}
    </div>
  )
}
